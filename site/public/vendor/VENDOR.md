...
| ディレクトリ | 版 | 取得元 |
|---|---|---|
| `hechima/`（hechima.js / hechima-worker.js / hechima.d.ts） | **v0.8.1** | labo Release `hechima-v0.8.1`（学習 + Phase 2 BS/U = よみに戻す） |
...
- hechima v0.8.1 は **KeymapEngine >= 1.2.0 必須**（セット差し替え）
