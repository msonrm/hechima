...
| ディレクトリ | 版 | 取得元 |
|---|---|---|
| `hechima/`（hechima.js / hechima-worker.js / hechima.d.ts） | **v0.8.0** | labo Release `hechima-v0.8.0`（学習 = cb.learn + worker 内 OPFS 永続化） |
...
- hechima v0.8.0 は **KeymapEngine >= 1.2.0 必須**（セット差し替え）
